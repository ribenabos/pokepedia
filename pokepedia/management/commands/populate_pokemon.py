...
class Command(BaseCommand):
    help = 'Populate the database with data from the Pokémon API.'

    def handle(self, *args, **options):
        for pokemon_id in range(1, 899):  # Change the range to populate more or less Pokemon
            ...
            if created:
                ...
                self.stdout.write(self.style.WARNING(f'Pokemon already exists: {pokemon.name}'))
